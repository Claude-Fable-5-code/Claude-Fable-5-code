...
### [P16] — مراجعة الجولة الخامسة للاستشاري: سد ثغرات التجاوز (IN PROGRESS ⏳ — awaiting CI)
...
- **الحالة:** البوابات محلياً clean/clean، اختبار الخطاف 3/3 — **بانتظار CI الأخضر قبل كتابة DONE** (القاعدة 4). الرفع من الـ sandbox محجوب لغياب صلاحية GitHub؛ patch + bundle مُصدَّران.
- **إجراءات يدوية للمالك (لا يجوز للوكيل تنفيذها):** إبطال التوكنات الثلاثة؛ حذف/تخصيص الـ gists؛ تفعيل Secret scanning + Push protection؛ استيراد الـ ruleset.
