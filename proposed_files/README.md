...
> راجع وثيقة **[`docs/GLOBAL_HISTORICAL_LEDGER.md`](file:///docs/GLOBAL_HISTORICAL_LEDGER.md)** المحفوظة بالكامل طبقاً للقانون 10 (العزل الهندسي الصارم).
...
| **الدستور الحاكم** | [`.agents/AGENTS.md`](file:///.agents/AGENTS.md) + [`.agents/rules/00-bolla-constitution.md`](file:///.agents/rules/00-bolla-constitution.md) |
| **النواة المعتمدة (SSOT)** | مجلد **[`Root/`](file:///Root/)** المشفر بالمراسي التشفيرية SHA-256 |
...
2. **قاعدة المزامنة القهرية (§FATAL RULE #SYNC):** تحديث بوصلة الحالة بعد كل خطوة إلزامي.
